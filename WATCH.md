...
|---|---|---|---|---|---|---|---|---|
| W1 | /illnesses/dementia | dementia treatment | YMYL_recovery | 2026-06-09 | Sprint A (commit `270cf0c`) | impressions +15-25% | 2026-06-23 | 🟡 **EVALUATED 2026-06-24 — PARTIAL (position-only)** (alert + `rank-recovery-watch.txt`). GSC impr 84→75 (−10.7%), pos 7.5→**4.9** (+2.6). Position improved but query base stayed collapsed (33 vs 280-420 early May) = fewer-but-better-matched impressions, NOT real impression recovery. Target (+15-25%) MISSED. Pending Learner formal close 06-28. |
| W2 | /illnesses/alzheimers | alzheimers treatment | YMYL_recovery | 2026-06-09 | Sprint A | +15-25% | 2026-06-23 | 🔴 **EVALUATED 2026-06-24 — WORSE.** GSC impr 29→23 (−20.7%), pos 10.5→**13.1** (worsened). Reviewer fix did not recover. **Refresh GATED on cannibalization diagnostic vs /illnesses/dementia (#19)** — dementia page already covers Alzheimer's heavily; may need consolidation, not refresh. Recovery brief drafted (`recovery-followup-alzheimers-2026-06-23.md`) HELD (YMYL+algo_watch). Pending Learner close 06-28. |
| W3 | /illnesses/posttraumatic-stress-disorder-ptsd | ptsd | YMYL_recovery | 2026-06-09 | Sprint A | +15-25% | 2026-06-23 | 🔴 **EVALUATED 2026-06-24 — STALLED (worst impr delta).** GSC impr 803→**241** (−70.0%), pos ~10 stable, but **query count ROSE 57→61** — unusual. ⚠ Possible GSC week under-report → **re-verify at 21-day window 06-30** before committing a heavy rewrite. Recovery brief drafted (`recovery-followup-ptsd-2026-06-23.md`) HELD (YMYL+algo_watch). Pending Learner close 06-28. |
| W4 | /illnesses/drug-addiction | drug addiction | YMYL_recovery | 2026-06-09 | Sprint A | +15-25% | 2026-06-23 | 🔴 **EVALUATED 2026-06-24 — STALLED.** GSC impr 511→450 (−11.9%), pos 17.6→**19.4** (worsening). 3rd in line for content-depth recovery brief if ptsd+alzheimers confirm the pattern. DataForSEO read pos-100 today = exact-100 noise (AP8), not a fresh collapse; GSC pos 19.4 is the reliable signal. Pending Learner close 06-28. |
| W5 | /treatments/eclectic-therapy | eclectic therapy | YMYL_recovery | 2026-06-09 | Sprint A | +15-25% | 2026-06-23 | 🔴 **EVALUATED 2026-06-24 — STALLED.** GSC impr 433→417 (−3.7%), pos 10.2→9.9 (flat). No recovery, no further harm. Pending Learner close 06-28. |
| W6 | /treatments/biofeedback-therapy | biofeedback therapy | YMYL_recovery | 2026-06-09 | Sprint A | +15-25% | 2026-06-23 | 🟢 **EVALUATED 2026-06-24 — RECOVERED.** GSC impr 326→**375** (+15.0%), pos 31.9→**25.7** (+6.2). The 1/6 that recovered — note it had the lowest starting position (most headroom). Pending Learner formal close 06-28. |
