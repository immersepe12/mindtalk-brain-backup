...
| W12 | /blogs/couple-therapy-techniques | couple therapy techniques | NEW_indexation | 2026-06-17 | Auto-ship NEW blog (`549dac3`) | indexed + impressing within 4-6wk | 2026-07-01 | open |
| W13 | /blogs/how-to-find-a-therapist-for-ocd | how to find a therapist for ocd | NEW_indexation | 2026-06-17 | Auto-ship NEW blog (`549dac3`) | indexed + impressing within 4-6wk | 2026-07-01 | open |
| W14 | /blogs/how-to-find-a-therapist-in-india | how to find a therapist in india | NEW_indexation | 2026-06-17 | Auto-ship NEW blog (`549dac3`) | indexed + impressing within 4-6wk | 2026-07-01 | open |
...
| 15 NEW quarantined pos-100 URLs (06-18 set: mood-disorder, narrative-therapy, anxiety-symptoms-in-men, psychological-distress-coping, brain-imaging-bipolar, sleep-disorder-comorbid, how-anxiety-affects-sleep, death-from-stress, overcome-depression, unrealistic-expectations, trichotillomania-children, children-with-autism, chronic-insomnia, prolonged-grief, yoga-for-anxiety) | Fri 2026-06-19 daily rank pull re-checks them | If the *same* ≥4 URLs report exactly 100 AGAIN on 06-19 → escalate to genuine deindex investigation. If recovered (expected, per P5/AP5) → confirmed noise, no watch needed. Assume noise until 06-19 confirms. |
...
| W11 homepage (check 2026-06-19) | Mixpanel access is BLOCKED (`memory/mixpanel-access-blocked.md`) | 06-19 conversion read will be **partial** — rank/impr proxy only until Mixpanel MCP enabled |
