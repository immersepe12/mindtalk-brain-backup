...
**Last updated:** 2026-06-29 (Strategist daily — Monday. ⚠ **STRATEGIST FLAG:** "burnout treatment" CRITICAL drop in weekly summary (pos 6.8→85.9, -79.1). W22 opened (read-only investigation + AP5 check). 3 YMYL pages confirmed LIVE (W19/W20/W21: emdr-for-ptsd, biofeedback-therapy-for-anxiety, talk-therapy-for-depression). W18 /treatments/online-therapy confirmed LIVE. Life-coach-therapy "what is a life coach" cluster lost 4,654 impr WoW — QDF deflation normalized; avg position should improve next week as this drags the avg lower (previously it inflated avg pos to 11.3; with it gone, expect avg pos improvement). REBT cluster breakout +316.7% WoW (981→4,088 impr, pos 11.1) — monitoring for spike vs. sustained. Clicks WoW slightly down (-2.6%) but position improved 11.3→10.5. ALGO_WATCH clears ~07-02. Step 10 apply-pass NO-OP (all 3 proposals apply 07-05). Prior Learner update 2026-06-28 below.)
...
7. **QDF spike + cannibalization pattern in burnout cluster** (detected 2026-06-29, W22)
   - "burnout treatment" page published 2026-05-18 hit pos 6.8 by Jun 13-19 (~26-33 days post-publish = classic QDF window), then collapsed to 85.9 by Jun 20-26. 4 sibling burnout pages exist including guide-to-burnout-syndrome.mdx (184kb = very large, competing for the same cluster). AP5 spike check pending.
   - Hypothesis: pos 6.8 was a QDF boost for a newly published page, which has now normalized. The page may also be cannibalised by the large guide-to-burnout-syndrome.mdx. If confirmed → add burnout-treatment to #18 recovery batch with differentiation strategy (not consolidation).
   - Status: **PENDING INVESTIGATION** (read-only; ALGO_WATCH held until 07-02; AP5 check pending)
   - **NEW weekly drops (Jun 20-26) from flagged-drops.json** — all held under ALGO_WATCH:
     - relationship-problem: pos 15.6→38.8 (-23.2). Low impr (78), possibly spike.
     - psychosis: pos 5.8→12.7 (-6.9). 183 impr — meaningful. Check spike.
     - counsellor-bangalore: pos 8.8→19.0 (-10.2). 40 impr. P9 GEO priority.
     - therapists-in-bangalore / therapist-in-hyderabad: pos drops 6.4–6.9. P9 GEO priority. Bangalore = 65% of booking intent.
     - separation-anxiety-in-babies: pos 5.7→11.6 (-5.9). Was 5.7 a spike?
   - ⚠ Bangalore geo drops are a conversion threat (65% of booking intent per T19 GEO data). Prioritize after ALGO_WATCH + AP5 check.
